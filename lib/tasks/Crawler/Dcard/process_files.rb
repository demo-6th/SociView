def mv_files(table_title)
  ...
  Dir.mkdir("#{Rails.root}/lib/tasks/Crawler/Dcard/#{clean_title}") unless Dir.exists?("#{Rails.root}/lib/tasks/Crawler/Dcard/#{clean_title}")
  FileUtils.mv("#{Rails.root}/lib/tasks/Crawler/Dcard/post_id.csv", "#{Rails.root}/lib/tasks/Crawler/Dcard/#{clean_title}/")
  FileUtils.mv("#{Rails.root}/lib/tasks/Crawler/Dcard/post_content.csv", "#{Rails.root}/lib/tasks/Crawler/Dcard/#{clean_title}/")
  FileUtils.mv("#{Rails.root}/lib/tasks/Crawler/Dcard/post_comment.csv", "#{Rails.root}/lib/tasks/Crawler/Dcard/#{clean_title}/")
